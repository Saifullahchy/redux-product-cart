...
import { cartDecrement, cartIncrement, deleteProduct } from "../redux/cart/actions";
import ProductItem from "./product-item";

const CartItem = ({ imageURL, productName, productCategory, price, quantity, id }) => {
        ...
        <div className="cartCard">
            ...
            <div className="flex items-center justify-center col-span-4 mt-4 space-x-8 md:mt-0">
                ...
                <div className="flex items-center space-x-4">
                    <button className="lws-incrementQuantity" onClick={() => handleIncrement(id)}>
                        <i className="text-lg fa-solid fa-plus" />
                    </button>
                    <span className="lws-cartQuantity">{quantity}</span>
                    <button className="lws-decrementQuantity" onClick={() => handleDecrement(id)}>
